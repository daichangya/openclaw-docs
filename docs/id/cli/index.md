...
title: Referensi CLI
x-i18n:
    generated_at: "2026-04-23T09:19:08Z"
    model: gpt-5.4
    provider: openai
...
halaman referensi khusus atau didokumentasikan bersama perintah yang di-alias-kan; indeks
...
| Pesan dan agent | [`message`](/id/cli/message) · [`agent`](/id/cli/agent) · [`agents`](/id/cli/agents) · [`acp`](/id/cli/acp) · [`mcp`](/id/cli/mcp)                                                                                                       |
...
| `--update`              | Bentuk singkat untuk [`openclaw update`](/id/cli/update) (khusus instalasi source) |
...
`openclaw status --usage` dan UI Control menampilkan penggunaan/kuota provider saat
...
Lihat [Usage tracking](/id/concepts/usage-tracking) untuk detailnya.
