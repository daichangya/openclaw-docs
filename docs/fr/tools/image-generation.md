...
L’outil `image_generate` permet à l’agent de créer et de modifier des images à l’aide de vos fournisseurs configurés. Les images générées sont automatiquement envoyées en tant que pièces jointes multimédias dans la réponse de l’agent.
...
- [Vydra](/fr/providers/vydra) — configuration de Vydra pour les images, les vidéos et la parole
